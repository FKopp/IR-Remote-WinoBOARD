...
#	define BLINKLED        2
#	define BLINKLED_ON()   (digitalWrite(2, HIGH))
#	define BLINKLED_OFF()  (digitalWrite(2, LOW))
...
//ATtiny85
  ...
  //Wino Board
#elif defined(__SAMD21E17A__)
  #define IR_USE_SAMD_TIMERS     // tx = pin 3  
...
//---------------------------------------------------------
// Wino board uses timer 5 for 50us counter and timer 0 CH3 for PWM output.
// Can connet any pin for IR input signa. Use pin 12(PA19) for IR transmit
#elif defined(IR_USE_SAMD_TIMERS)
    // IR receive side
//   #define TCx                 TC5
