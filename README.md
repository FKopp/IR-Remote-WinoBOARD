# IRremote Arduino and WinoBOARD Library
...
## Version - 2.1.0 -> + WinoBOARD added

## Installation
1. Move the "IRremote" folder that has been extracted to your libraries directory.
2. Make sure to delete Arduino_Root/libraries/RobotIRremote. Where Arduino_Root refers to the install directory of Arduino. The library RobotIRremote has similar definitions to IRremote and causes errors.
